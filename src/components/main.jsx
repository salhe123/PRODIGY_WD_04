...
import esuba from '../image/esuba.jpg';
import {FaTwitter,FaFacebook,FaInstagram,FaLinkedin} from 'react-icons/fa';
export const Main = () => {
  return (
    <div id='main'>
        <img className=' w-full h-screen object-cover object-left scale-x-[-1]' src={esuba} alt="esuba" />
        <div className=' w-full h-screen absolute top-0 left-0 bg-white/50'> 
               <div className=' max-w-[700px] m-auto h-full w-full flex flex-col justify-center lg:items-start items-center'>
                <h1 className=' sm:text-5xl text-4xl font-bold text-gray-800'> I am Esubalew Teshager</h1>
